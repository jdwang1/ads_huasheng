...
function i(e){
var i=[],n=e.container,s=e.imgs||[];
if(n)for(var d=n.getElementsByTagName("img")||[],c=0,m=d.length;m>c;c++)s.push(d.item(c));
for(var g=p.isIOS&&1==window._copyright_stat&&1==window.is_need_reward,w=0,c=0,m=s.length;m>c;c++){
var u=s[c],l=u.getAttribute("data-src")||u.getAttribute("src"),_=u.getAttribute("data-type");
if(l&&!l.isGif()&&0!=l.indexOf("data:")){
for(;-1!=l.indexOf("?tp=webp");)l=l.replace("?tp=webp","");
u.dataset&&u.dataset.s&&l.isCDN()&&(l=l.replace(/\/640$/,"/0"),l=l.replace(/\/640\?/,"/0?")),
l.isCDN()&&(l=r.addParam(l,"wxfrom","3",!0)),l=e.is_https_res?l.http2https():l.https2http(),
_&&(l=r.addParam(l,"wxtype",_,!0)),i.push(l),"1"!=u.getAttribute("data-nopreviewclick")&&!function(e){
o.on(u,"click",function(o){
...
for(var n=o.target,r=!0;n&&"body"!=n.nodeName.toLowerCase();){
var s=window.getComputedStyle(n,null),d=parseInt(s.getPropertyValue("opacity")),p=s.getPropertyValue("visibility");
if(1!=d||"visible"!=p){
r=!1;
break;
}
...
var c=new Image,m="https://badjs.weixinbridge.com/badjs?id=168&level=4&from="+encodeURIComponent(location.href)+"&msg="+encodeURIComponent(e);
c.src=m.slice(0,1024);
}
return!1;
}
}
t(e,i),g&&0==w&&a(o.target.src,2);
}
});
}(l),u.removeAttribute("data-nopreviewclick");
}
}
if(g){
var f=document.getElementById("js_content"),b=0,v=0;
o.on(f,"touchstart",function(e){
return e&&e.target&&e.target.tagName&&"string"==typeof e.target.tagName&&"IMG"==e.target.tagName.toString().toUpperCase()?(w=+new Date,
b=e.touches[0].pageX,void(v=e.touches[0].pageY)):void(w=0);
}),o.on(f,"touchmove",function(e){
var t=e.touches[0].pageX,a=e.touches[0].pageY;
Math.abs(t-b)>10&&Math.abs(a-v)>10&&(w=0);
}),o.on(f,"touchend",function(e){
